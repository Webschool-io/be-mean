...
```
marcelo(mongod-3.0.6) be-mean-pokemons> show dbs
...
```
marcelo(mongod-3.0.6) be-mean-pokemons> show collections
...
```
marcelo(mongod-3.0.6) be-mean-pokemons>
var pokemons = [
  {
    "name": "Kabuto",
...
marcelo(mongod-3.0.6) be-mean-pokemons> db.pokemons.insert(pokemons)
...
```
marcelo(mongod-3.0.6) be-mean-pokemons> db.pokemons.find()
{
...
## Kabuto (passo 6)
```
marcelo(mongod-3.0.6) be-mean-pokemons> var q = {name: "Kabuto"}
marcelo(mongod-3.0.6) be-mean-pokemons> var pokemon = db.pokemons.findOne(q)
marcelo(mongod-3.0.6) be-mean-pokemons> pokemon
{
  "_id": ObjectId("5643c99c5d161e0aea59a9aa"),
  "name": "Kabuto",
  "description": "It is thought to have inhabited beaches 300 million years ago. It is protected by a stiff shell.",
...
```
marcelo(mongod-3.0.6) be-mean-pokemons> pokemon.description = "The Real pokemons are awesome!!"
marcelo(mongod-3.0.6) be-mean-pokemons> db.pokemons.save(pokemon)
